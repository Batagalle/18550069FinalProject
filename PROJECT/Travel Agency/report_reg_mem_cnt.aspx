<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_reg_mem_cnt.aspx.cs" Inherits="Travel_Agency.reg_mem_cnt_rep" %>
...
<head runat="server">
    ...
    <title>Registered Members (Count By Country) Report</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="row">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <center><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u><asp:Label ID="Label12" runat="server" Text="Registered Members (Count By Country) Report"></asp:Label></u></h2></center>
                                </td>
                            </tr>
                        </table>
                ...
                <br/>
                <h4>
                    Registered Members (Count By Country) Report<br/>
                ...
                <br />
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" DataTextField="country" AutoGenerateColumns="False" AppendDataBoundItems="True" AutoPostBack="True" CellPadding="4" ForeColor="#333333" GridLines="None" CellSpacing="2" Width="500px" Class="table">

                                        <Columns>
                    <asp:BoundField DataField="country" HeaderText="Country" ItemStyle-Width="250px"/>
                    <asp:BoundField DataField="cus_count" HeaderText="No.Of Members" ItemStyle-Width="150px"/>
                </Columns>
