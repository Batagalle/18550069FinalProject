<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="familyescapes.aspx.cs" Inherits="Travel_Agency.familyescapes" %>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="box">
                    <div class="col-lg-12">
                        <hr>
                        <h2 class="intro-text text-center"><b>Family Escape ! ! ! </b>
                            <br />
                        ...
                        <img class="img-responsive img-left rcorners002" src="img/kandy lake.jpg" alt="">
                        ...
                        <p>
                            <center><font size="3"> 
                           To enjoy a family holiday and for children of all ages, Sri Lanka offers you a number of options to choose from.
                             There are so many experiences to be had whether its seeing an elephant in the wild; spotting a blue whale off 
                            Mirissa, the largest mammal to have ever existed on the planet; learning how rice grows and is harvested; 
                            discovering the health properties of spices and rainforest plants and understanding the basic ideas behind 
                            Buddhism by visits to some of the island’s temples.
                               </font></center>
                        </p>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="team-member">
                                    ...
                                    <img src="img/dambullaCave.jpg" class="img-responsive rcorners003" alt="">
                                    <center><h4>A Short Escape</h4></center>

                                    <p class="text-muted">From great archaeological ruins to the sunny side of Sri Lanka, let’s see, let’s walk and let’s talk...</p>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="team-member">
                                    ...
                                    <img src="img/pinnawala.jpg" class="img-responsive rcorners003" alt="">
                                    <center><h4>Something Old Something New</h4></center>

                                    <p class="text-muted">This is an itinerary specifically made to fit in your busy lifestyle. With all the fascinations...</p>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="team-member">
                                    ...
                                    <img src="img/Polonnaruwa.jpg" class="img-responsive rcorners003" alt="">
                                    <center><h4>Through The Time line</h4></center>

                                    <p class="text-muted">Sri Lanka is all about various moods and moments. By enlisting with us, you will be taken through...</p>
                                </div>
