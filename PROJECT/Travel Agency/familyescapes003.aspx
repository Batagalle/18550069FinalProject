<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="familyescapes003.aspx.cs" Inherits="Travel_Agency.familyescapes003" %>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="box">
                    <div class="col-lg-12">
                        <hr>
                        <h2 class="intro-text text-center"><b>Through The Time Line ! ! ! </b>
                            <br />
                        ...
                        <img class="img-responsive img-left rcorners002" src="img/sigiriya.jpg" alt="">
                        ...
                        <p>
                            <center><font size="3"> 
                          Sri Lanka is all about various moods and moments. By enlisting with us, you will be taken through a rich majestic past, unique and iconic natural topographies and splendid coastal lines offering you a Sun, Sea and Sand experience for a lifetime.
                               </font></center>
                        </p>
                        <br />
                        <br />
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    <center><img class="img-responsive img-left rcorners002 fancybox" src="img/thumb-map.jpg" data-big="img/maps/Through The Time Line.jpg" alt=""> </center>
                                </td>
                                <td>
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="tourIte">
                            <div class="day">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    ...
                                    <p>
                                        <font size="2">
                                                You will be met &amp; assisted upon arrival at the International Airport and be transferred to Negombo.
                                                </font>
                                    </p>
                                    <div class="specialIntro div456"><font color="white">Overnight stay at <strong>Negombo</strong></font></div>
                                </div>
                            ...
                            <div class="day">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    ...
                                    <p>
                                        <font size="2">
                                                After breakfast rest of the day is free for leisure.
                                                </font>
                                    </p>
                                    <div class="specialIntro div456"><font color="white">Overnight stay at Negombo</font></div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="day">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <h4 class="div123"><font color="white">NEGOMBO / PINNAWALE / DAMBULLA</font></h4>
                                    <p>
                                        <font size="2">
...
surroundings.
                                    ...
                                    <div class="specialIntro div456"><font color="white">On Completion return to hotel<br>Overnight stay at <strong>Dambulla</strong>.</font></div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
...
spices and shown how some of these spices are grown and processed
                                    ...
                                    <p>
                                        <font size="2">
                                                Evening visit the Temple of 
the Tooth Relic and thereafter proceed to an auditorium and witness a 
cultural show featuring traditional Sri Lankan dancing.
                                                </font>
                                    </p>
                                    <div class="specialIntro div456"><font color="white">Overnight stay at <strong>Kandy</strong></font></div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="day">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <h4 class="div123"><font color="white">Kandy</font></h4>
                                    <p>
                                        <font size="2">
...
Bazaar, the arts &amp; crafts center, a gem museum, a lapidary and Batik
 factory. 
                                    ...
                                    <div class="specialIntro div456"><font color="white">On completion return to hotel<br>Overnight stay at <strong>Kandy</strong></font></div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="day">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <h4 class="div123"><font color="white">KANDY / ELLA</font></h4>
                                    <p>
                                        <font size="2">
                                                After breakfast proceed to 
Ella. Thereafter do a small city tour in Ella. Ella is blessed with some
 of the most beautiful views, you could find in Sri Lanka.Only 8 km from
 Bandarawela, this small town is used as a base for plenty of trekking 
expeditions to the surrounding countryside. Some of th e places you 
could see in Ella are the Ella Gap, Ravana Ella Falls, Little Adam's 
Peak and Bambaragala Peak among the other many varied pleasant walks 
...
Bazaar, the arts &amp; crafts center, a gem museum, a lapidary and Batik
 factory. 
                                    ...
                                    <div class="specialIntro div456"><font color="white">Overnight stay at  Ella.</font></div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="day">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <h4 class="div123"><font color="white">ELLA / BERUWALA</font></h4>
                                    <p>
                                        <font size="2">
                                    ...
                                    <div class="specialIntro div456"><font color="white">Overnight stay at <strong>Beruwala</strong>.</font></div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="day">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <h4 class="div123"><font color="white">BERUWALA / COLOMBO</font></h4>
                                    <p>
                                        <font size="2">
                                            After breakfast proceed to 
Colombo. Evening commence a city &amp; shopping tour.  Colombo is fast 
changing and developing to the modern city preserving the old charm to 
its splendor. Here visit the 100 years old clock tower, elegant 
historical building and many places like Pettah Bazaar, Buddhist Temple 
and Bandaranaike Memorial International Conference Hall on your Colombo 
tour. Enjoy shopping in the colorful bazaars to take home lots of 
souvenirs, artifacts and Sri Lanka delights.
                                                </font>
                                    </p>

                                    <div class="specialIntro div456"><font color="white">Overnight Stay at <strong>Colombo</strong></font></div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
