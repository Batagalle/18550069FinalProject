...
{
    public partial class specialinterest : System.Web.UI.Page
    {
        public string main_cat = "Special Interest Tours";
        public string uname;
        ...
        {
            Response.Redirect("specialinterest001.aspx?val1=" + main_cat + "&user=" + uname);
        }

        protected void Button3_Click(object sender, EventArgs e)
        {
            Response.Redirect("specialinterest002.aspx?val1=" + main_cat + "&user=" + uname);
        }

        protected void Button4_Click(object sender, EventArgs e)
        {
            Response.Redirect("specialinterest003.aspx?val1=" + main_cat + "&user=" + uname);
        }
