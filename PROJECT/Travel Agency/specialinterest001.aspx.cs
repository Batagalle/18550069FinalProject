...
{
    public partial class specialinterest001 : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("Content-Disposition", "attachment; filename=Adventure_&_Camping.pdf");
            Response.TransmitFile(Server.MapPath("tours pdf/Adventure & Camping.pdf"));
            Response.End();
        }     
