<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_mntly_incm_fxd_tr.aspx.cs" Inherits="Travel_Agency.report_mntly_incm_fxd_tr" %>
...
<head runat="server">
    ...
    <title>Monthly Income (Fixed Tours) Report</title>
        ...
        <div class="container">
            ...
            <div class="row">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <center><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u><asp:Label ID="Label12" runat="server" Text="Monthly Income (Fixed Tours) Report"></asp:Label></u></h2></center>
                                </td>
                            </tr>
                        </table>
                ...
                <h4>
                    ...
                    Monthly Income (Fixed Tours) Report<br/>                  
