...
{
    public partial class specialinterest002 : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("Content-Disposition", "attachment; filename=Architectural_Tour.pdf");
            Response.TransmitFile(Server.MapPath("tours pdf/Architectural Tour.pdf"));
            Response.End();
