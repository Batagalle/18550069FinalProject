...
{
    public partial class report_cur_inq_fxd_tr : System.Web.UI.Page
    {
        public string uname;
        ...
        {
            con.Open();
            com = new MySqlCommand("SELECT * FROM cus_tours WHERE `travel_date`> DATE(NOW()) AND STATUS LIKE 'N'", con);
