...
{
    public partial class report_mntly_incm_fxd_tr : System.Web.UI.Page
    {
        public string uname;
        ...
        private void GridView1Binding()
        {
            ...
            com = new MySqlCommand("SELECT c.tid AS 'Ref. No',c.main_category AS 'Main Package',c.sub_category AS 'Sub Package',c.budget AS 'Charge (US $)' FROM cus_tours c WHERE c.status_date LIKE '" + Label8.Text + "%' AND c.status= 'Y' ", con);
