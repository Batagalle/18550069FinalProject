...
{
    public partial class wildlife003 : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                string exe = "Error";
                ClientScript.RegisterStartupScript(this.GetType(), "Error", "alert('" + exe + "');", true);
            }
        }
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("Content-Disposition", "attachment; filename=Let's_Go_Wild.pdf");
            Response.TransmitFile(Server.MapPath("tours pdf/Let's Go Wild.pdf"));
            Response.End();
        }
