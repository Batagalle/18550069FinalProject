<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_cur_inq_cstmz_tr.aspx.cs" Inherits="Travel_Agency.report_cur_inq_cstmz_tr" %>
...
<head runat="server">
    ...
    <title>Current Inquiries (Customize Tours) Report</title>
        ...
        <div class="container">
            ...
            <div class="row">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <center><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u><asp:Label ID="Label12" runat="server" Text="Current Inquiries (Customize Tours) Report"></asp:Label></u></h2></center>
                                </td>
                            </tr>
                        </table>
                ...
                <h4>
                    ...
                    Current Inquiries (Customize Tours) Report<br/>                  
                    As At &nbsp;
                ...
                <asp:GridView ID="GridView1" runat="server" DataTextField="country" AutoGenerateColumns="False" AppendDataBoundItems="True" AutoPostBack="True" CellPadding="4" ForeColor="#333333" GridLines="None" CellSpacing="2" Width="1000px" Class="table">
                    ...
                    <Columns>
                    <asp:BoundField DataField="ctid" HeaderText="Ref. No" ControlStyle-Width="97%"/>
                    ...
                    <asp:BoundField DataField="budget" HeaderText="Budget (per Person)" ControlStyle-Width="97%" />
