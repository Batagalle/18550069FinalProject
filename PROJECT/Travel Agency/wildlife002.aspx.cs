...
{
    public partial class wildlife002 : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("Content-Disposition", "attachment; filename=Nature_and_Us.pdf");
            Response.TransmitFile(Server.MapPath("tours pdf/Nature and Us.pdf"));
            Response.End();
        }
