<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="familyescapes001.aspx.cs" Inherits="Travel_Agency.familyescapes001" %>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="box">
                    <div class="col-lg-12">
                        <hr>
                        <h2 class="intro-text text-center"><b>A Short Escape ! ! ! </b>
                            <br />

                        </h2>
                        <hr>

                        <img class="img-responsive img-left rcorners002" src="img/polonnaruwa-temple-building.jpg" alt="">

                        <hr class="visible-xs">

                        <p>
                            <center><font size="3"> 
                          From great archaeological ruins to the sunny side of Sri Lanka, let’s see, let’s walk and let’s talk, about a country that is so small, 
                          but offers so much more than its size. This is one of the great isles to spend those special moments with your loved ones.
                               </font></center>
                        </p>
                        <br />
                        <br />
                        ...
                        <table>
                            ...
                            <tr>
                                <td>                                    
                                    <center><img class="img-responsive img-left rcorners002 fancybox" src="img/thumb-map.jpg" data-big="img/maps/A Short Escape.jpg" alt=""> </center>                                   
                                </td>
                        ...
                        <div class="tourIte">
                            <div class="day">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <h4 class="div123"><font color="white">ARRIVAL TRANSFER / MINNERIYA / DAMBULLA</font></h4>
                                    <p>
                                        <font size="2">
                                        You will be met &amp; assisted upon arrival at the International Airport and be transferred to Dambulla.</font>
                                    </p>
                                    <div class="specialIntro div456"><font color="white">Overnight stay at Dambulla</font></div>
                                </div>
...
Sigirya and visit the 5th century Sigiriya rock fortress which is a 
...
These frescoes are painted in earth pigments on plaster.<p>
                                    </font>
                                        </p>
                                        <p>
                                            <font size="2">
...
Tooth Relic.
                                        ...
                                        <div class="specialIntro div456">
                                            <font color="white">
                                            On completion return to hotel<br>
...
largest is the colossal figure of the Buddha carved out of rock spanning
 14 meters. </font>
                                    ...
                                    <p>
                                        <font size="2">
                                        Thereafter proceed to Kandy. En
 route visit a spice garden in Matale to see the different spices, which
 Sri Lanka is famous for. You will be introduced to different spices and
 shown how some of these spices are grown and processed
                                              </font>
                                    </p>
                                    <p>
                                        <font size="2">
...
cultural show featuring traditional Sri Lankan dancing. </font>
                                    </p>
                            ...
                            <div class="day">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <h4 class="div123"><font color="white">KANDY / BERUWALA</font></h4>
                                    <p>
                                        <font size="2">
                                        After breakfast proceed to 
Beruwala. En route visit Peradeniya Botanical Gardens. This botanical 
garden was first built as a pleasure garden by a Sinhala king and was 
expanded by the British.  It is 147 acres in extent and provides an 
amazing variety of trees, plants and flowers. Also visit the Temple of 
...
cultural show featuring traditional Sri Lankan dancing.
                            ...
                            <div class="day">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <h4 class="div123">BERUWALA</h4>
                                    <p>
                                        <font size="2">
                                        After breakfast spend day at leisure on the beach. </font>
                                    </p>
                            ...
                            <div class="day">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <h4 class="div123">BERUWALA / DEPARTURE TRANSFER</h4>
                                    <p>
                                        <font size="2">
                                        After breakfast leave in time to connect with departure flight. </font>
                                    </p>
