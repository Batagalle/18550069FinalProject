...
{
    public partial class familyescapes : System.Web.UI.Page
    {

        public string main_cat = "Family Escapes";
        public string uname;
        ...
        {           
            Response.Redirect("familyescapes001.aspx?val1=" + main_cat+"&user="+uname);
        }

        protected void Button3_Click(object sender, EventArgs e)
        {            
            Response.Redirect("familyescapes002.aspx?val1=" + main_cat + "&user=" + uname);
        }

        protected void Button4_Click(object sender, EventArgs e)
        {         
            Response.Redirect("familyescapes003.aspx?val1=" + main_cat + "&user=" + uname);
        }
