<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_vehi.aspx.cs" Inherits="Travel_Agency.report_vehi" %>
        ...
        <div class="container">
            ...
            <div class="row">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <center><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u><asp:Label ID="Label12" runat="server" Text="Vehicle Report"></asp:Label></u></h2></center>
                                </td>
                            </tr>
                        </table>
                ...
                <h4>
                    ...
                    Vehicle Report By Vehicle Type : <asp:Label ID="vtype_Label" runat="server" Text=""></asp:Label><br/>                  
                    ...
                    <asp:Label ID="date_lbl" runat="server" Text=""></asp:Label></h4> </center>
                                ...
                                <center>             
                                    <asp:Label ID="Label5" runat="server" Font-Size="Medium" ForeColor="Red" Visible="False"></asp:Label>
                <asp:GridView ID="GridView1" runat="server" DataTextField="vtype" AppendDataBoundItems="True" AutoPostBack="True" CellPadding="4" ForeColor="#333333" GridLines="None" CellSpacing="2" Width="1000px" Class="table" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
