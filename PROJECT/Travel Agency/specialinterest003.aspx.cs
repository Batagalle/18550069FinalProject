...
{
    public partial class specialinterest003 : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("specialinterest.aspx?user=" + uname);
        }
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("Content-Disposition", "attachment; filename=Archaeological_Tour.pdf");
            Response.TransmitFile(Server.MapPath("tours pdf/Archaeological Tour.pdf"));
            Response.End();
        }
