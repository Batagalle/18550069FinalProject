...
{
    public partial class report_cur_expct_incm_fxd_tr : System.Web.UI.Page
    {
        public string uname;
        ...
        private void GridView1Binding()
        {
            ...
            con.Open();            
            com = new MySqlCommand("SELECT * FROM cus_tours WHERE status_date LIKE '" + mnt + "%' AND STATUS= 'Y'", con);
