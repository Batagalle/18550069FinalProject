...
namespace Travel_Agency
{
    public partial class tours : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("customizetour.aspx?user=" + uname);
        }
        ...
        protected void LinkButton10_Click(object sender, EventArgs e)
        {
            ...
            {
                //ClientScript.RegisterStartupScript(this.GetType(),"Message","alert('"+ex.ToString() +"');",true);
                ClientScript.RegisterStartupScript(this.GetType(), "Message", "alert('failed');", true);
            }
        }
