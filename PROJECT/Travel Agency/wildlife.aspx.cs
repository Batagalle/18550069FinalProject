...
namespace Travel_Agency
{
    ...
    {
        public string main_cat = "Wild Life";
        public string uname;
        ...
        {
            Response.Redirect("wildlife001.aspx?val1=" + main_cat + "&user=" + uname);
        }

        protected void Button3_Click(object sender, EventArgs e)
        {
            Response.Redirect("wildlife002.aspx?val1=" + main_cat + "&user=" + uname);
        }

        protected void Button4_Click(object sender, EventArgs e)
        {
            Response.Redirect("wildlife003.aspx?val1=" + main_cat + "&user=" + uname);
        }
