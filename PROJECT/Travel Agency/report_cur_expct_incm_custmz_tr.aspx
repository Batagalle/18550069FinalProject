<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_cur_expct_incm_custmz_tr.aspx.cs" Inherits="Travel_Agency.report_cur_expct_incm_custmz_tr" %>
...
<head runat="server">
    ...
    <title>Current Expect Income (customize Tours) Report</title>
        ...
        <div class="container">
            ...
            <div class="row">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <center><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u><asp:Label ID="Label12" runat="server" Text="Current Expect Income (customize Tours) Report"></asp:Label></u></h2></center>
                                </td>
                            </tr>
                        </table>
                ...
                <h4>
                    ...
                    Current Expect Income (customize Tours) Report<br/>                  
                ...
                <asp:GridView ID="GridView1" runat="server" DataTextField="country" AutoGenerateColumns="False" AppendDataBoundItems="True" AutoPostBack="True" CellPadding="4" ForeColor="#333333" GridLines="None" CellSpacing="2" Width="700px" Class="table" OnRowDataBound="GridView1_RowDataBound">
                    ...
                    <asp:BoundField DataField="act_budget" HeaderText="Charge (US $)" ControlStyle-Width="97%" />
                </Columns>
