...
namespace Travel_Agency
{
    public partial class contact : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string too = "emeraldtours.pvtltd@gmail.com";

            string sub = "Contacts";
            string smtp = "smtp.gmail.com";

            string bodyy = "Name : " + TextBox1.Text + "\nEmail Address : " + TextBox2.Text + "\nPhone No : " + TextBox3.Text + "\nMessage : \n" + TextBox4.Text;

            string un = "emeraldtours.pvtltd@gmail.com";
            string pass = "emerald123@";

            MailMessage mail = new MailMessage(address,too,sub,bodyy);
            ...
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Your Message succesfully Sent')", true);
