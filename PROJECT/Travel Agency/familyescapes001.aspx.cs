...
{
    public partial class familyescapes001 : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("Content-Disposition", "attachment; filename=c.pdf");
            Response.TransmitFile(Server.MapPath("tours pdf/A Short Escape.pdf"));
            Response.End();           
        }
