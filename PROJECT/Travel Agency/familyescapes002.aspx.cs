...
{
    public partial class familyescapes002 : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            sub_cat = "Something Old Something New";
        }
        ...
        {
            Response.Redirect("familyescapes.aspx?user=" + uname);
        }
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("Content-Disposition", "attachment; filename=Something_Old_Something_New.pdf");
            Response.TransmitFile(Server.MapPath("tours pdf/Something Old Something New.pdf"));
            Response.End();
        }
